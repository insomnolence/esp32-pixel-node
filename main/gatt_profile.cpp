...
GattProfile::GattProfile(const uint16_t _app_id, const std::string& service_uuid_str, const std::string& characteristic_uuid_str) : service_handle(0), a_property(0), app_id(_app_id) {
    // Constructor
